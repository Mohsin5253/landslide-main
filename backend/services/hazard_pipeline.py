...
# Global Output Directories & Config
...
try:
    if os.path.exists(os.path.dirname(os.path.dirname(FRONTEND_DATA_DIR))):
            ...
            "layers": [
                {
                    ...
                    "wfs_url": f"{BACKEND_URL}/api/hazards/live",
                    "wms_url": f"{BACKEND_URL}/api/hazards/geonode/wms?layers=geonode:live_global_hazards",
                ...
                },
                {
                    ...
                    "wfs_url": f"{BACKEND_URL}/api/hazards/ner",
                    "wms_url": f"{BACKEND_URL}/api/hazards/geonode/wms?layers=geonode:ner_landslide_corridors",
                    "update_interval_sec": 900,
                    "last_updated": now_iso,
                    "schema_attributes": [
                ...
                },
                {
                    ...
                    "wfs_url": f"{BACKEND_URL}/api/hazards/earthquakes",
                    "wms_url": f"{BACKEND_URL}/api/hazards/geonode/wms?layers=geonode:earthquake_vectors",
                    "update_interval_sec": 900,
                    "last_updated": now_iso,
                    "schema_attributes": [
                ...
                },
                {
                    ...
                    "wfs_url": f"{BACKEND_URL}/api/hazards/cyclones",
                    "wms_url": f"{BACKEND_URL}/api/hazards/geonode/wms?layers=geonode:cyclone_tracks",
                    "update_interval_sec": 900,
                    "last_updated": now_iso,
                    "schema_attributes": [
                ...
                },
                {
                    ...
                    "wfs_url": f"{BACKEND_URL}/api/hazards/volcanoes",
                    "wms_url": f"{BACKEND_URL}/api/hazards/geonode/wms?layers=geonode:volcanic_alerts",
                    "update_interval_sec": 900,
                    "last_updated": now_iso,
                    "schema_attributes": [
                ...
                },
                {
                    ...
                    "wfs_url": f"{BACKEND_URL}/api/hazards/landslides",
                    "wms_url": f"{BACKEND_URL}/api/hazards/geonode/wms?layers=geonode:landslide_scarps",
                    "update_interval_sec": 900,
                    "last_updated": now_iso,
                    "schema_attributes": [
