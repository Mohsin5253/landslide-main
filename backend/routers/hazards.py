...
def get_hazard_analytics():
    ...
    return {
        ...
        "geonode_status": {
            ...
            "ogc_protocols": {
                "wfs_endpoint": f"{BACKEND_URL}/api/hazards/live",
                "wms_capabilities": f"{BACKEND_URL}/api/hazards/geonode/wms?request=GetCapabilities",
                "csw_catalog": f"{BACKEND_URL}/api/hazards/geonode/layers",
                "geojson_direct": f"{BACKEND_URL}/api/hazards/live_global_hazards.geojson"
            }
        }
    }
...
<WMS_Capabilities version="1.3.0" xmlns="http://www.opengis.net/wms" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <Service>
    ...
    <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="{BACKEND_URL}/api/hazards/geonode/wms"/>
  </Service>
  <Capability>
    <Request>
      <GetCapabilities>
        <Format>text/xml</Format>
        <DCPType><HTTP><Get><OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="{BACKEND_URL}/api/hazards/geonode/wms"/></Get></HTTP></DCPType>
      </GetCapabilities>
    </Request>
    <Layer>
