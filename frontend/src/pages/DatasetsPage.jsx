...
import { getDatasets, uploadDataset, deleteDataset, getDatasetPreview, runLandslideInference, BACKEND_ORIGIN } from '../api/client';
    ...
    <div style={{ padding: 20, height: 'calc(100vh - 56px)', overflow: 'auto' }}>
      ...
      {viewingFile && (() => {
        ...
        if (!isRasterDataset || imageLoadFailed) {
          ...
          imageUrl = `${BACKEND_ORIGIN}/uploads/${viewingFile}`;
        }
