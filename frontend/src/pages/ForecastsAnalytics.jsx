...
import { getForecasts, getImpact, getRiskScores, getDatasetStats, getScanBatch, BACKEND_ORIGIN } from '../api/client';
  ...
  const runScan = async () => {
    ...
    for (let i = 0; i < totalSteps; i++) {
      const item = batch[i] || {
        ...
        slope_deg: 39.4,
        image_url: `${BACKEND_ORIGIN}/flood-images/${i}.jpg`,
        mask_url: `${BACKEND_ORIGIN}/masks/${i}.png`,
  ...
  const generatedAlerts = (scanBatch.length ? scanBatch : [
    {
      ...
      confidence: 0.984,
      image_url: `${BACKEND_ORIGIN}/uploads/1041.jpg`,
      mask_url: `${BACKEND_ORIGIN}/uploads/1041.png`
    },
    {
      index: 5,
      filename: '5.jpg',
      ...
      confidence: 0.991,
      image_url: `${BACKEND_ORIGIN}/flood-images/5.jpg`,
      mask_url: `${BACKEND_ORIGIN}/masks/5.png`
    },
    {
      index: 2,
      filename: '2.jpg',
      ...
      confidence: 0.965,
      image_url: `${BACKEND_ORIGIN}/flood-images/2.jpg`,
      mask_url: `${BACKEND_ORIGIN}/masks/2.png`
    },
    {
      index: 0,
      filename: '0.jpg',
      ...
      confidence: 0.972,
      image_url: `${BACKEND_ORIGIN}/flood-images/0.jpg`,
      mask_url: `${BACKEND_ORIGIN}/masks/0.png`
    },
    {
      index: 4,
      filename: '4.jpg',
      ...
      confidence: 0.988,
      image_url: `${BACKEND_ORIGIN}/flood-images/4.jpg`,
      mask_url: `${BACKEND_ORIGIN}/masks/4.png`
    }
  ]).filter(item => {
          ...
          <div style={{
            ...
            <div style={{
              ...
              backgroundImage: currentScanItem?.image_url
                ...
                : `url("${BACKEND_ORIGIN}/flood-images/0.jpg")`,
